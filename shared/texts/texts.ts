const EN_TEXTS = {
	...
	portfolio: {
		...
		languages: `<strong>Languages</strong><br><br>• 🌍 English (A2), Russian (C2), Estonian (B2)`,
		techStack: `<strong>Skills</strong><br><br>• 🎨 <strong>Frontend:</strong> TypeScript, React, Tailwind CSS, Vike<br>• ⚙️ <strong>Backend:</strong> Node.js, MongoDB<br>• 🧪 <strong>Testing:</strong> Vitest<br>• 🛡️ <strong>Security & Tools:</strong> C++, Assembler, IDA, Ghidra, x64dbg`,
