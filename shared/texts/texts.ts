const EN_TEXTS = {
	...
	portfolio: {
		...
		skills: `<strong>Skills</strong><br><br>• 🎨 <strong>Frontend:</strong> TypeScript, JavaScript, React, Tailwind CSS, Vite, Vike, Electron<br>• ⚙️ <strong>Backend:</strong> Node.js, Express<br>• ☁️ <strong>Databases:</strong> MongoDB<br>• 🧪 <strong>Testing:</strong> Vitest<br>• 🛠️ <strong>Developer Tools:</strong> Git, Render, Vercel, OpenRouter, WebLLM, Stripe, Auth0, Figma<br>• 🦾 <strong>Systems:</strong> C++, Assembler, CMake<br>• 🛡️ <strong>Security Tools:</strong> Ghidra, x64dbg, Oracle VirtualBox<br>• 🌍 <strong>Languages:</strong> English (A2), Russian (C2), Estonian (B2)`,
