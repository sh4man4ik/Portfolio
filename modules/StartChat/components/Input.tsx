		...
		<>
			<div className="grid pt-[10px] p-[15px] bg-base-200 rounded-xl gap-[15px] max-w-[500px] w-[80%]">
				...
				<div className="flex justify-between">
					...
					<button className="group/button relative inline-flex items-center justify-center overflow-hidden rounded-md bg-[#FF97D0] backdrop-blur-lg px-6 py-2 text-base font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 border-none">
						<RiArrowUpLine size={18} color="rgba(0,0,0,1)" />
